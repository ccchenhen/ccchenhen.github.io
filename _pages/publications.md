...
## Journal Articles
* X. Dong, **C. Chen<sup>*</sup>**, G. Yu, L. Zhou, C. Yuan and J. Zhang, "Deep learning-based channel estimation for stacked intelligent metasurface-enhanced multi-user communications," _IEEE Trans. Veh. Technol._, accepted.
...
* X. Liu, **C. Chen**, and C. Fischione, "Cell-Free ISAC Systems: Learning-Based Channel Estimation and Coordinated Beamforming," _IEEE Trans. Cogn. Commun. Netw._, 2025. [PDF](https://ieeexplore.ieee.org/document/11251037)
* Z. Li, **C. Chen**, J. Zhang, C. R. C. M. Da Silva, O. Yurduseven, T. Q. Duong, and S. L. Cotton, "Sensing line of sight perturbations in 6 GHz Wi-Fi using channel model based features," _IEEE Sens. J._, 2025. [PDF](https://ieeexplore.ieee.org/document/11319341)
* T. Lu, L. Chen, J. Zhang, **C. Chen**, T. Q. Duong, and M. Matthaiou, "Precoding design for key generation in extremely large-scale MIMO near-field multi-user systems," _IEEE Trans. Inf. Forensics Secur._, vol. 20, pp. 10572-10587, 2025. [PDF](https://ieeexplore.ieee.org/abstract/document/11180896)
...
* **C. Chen**, and J. Zhang, “Machine learning enhanced near-field secret key generation for extremely large-scale MIMO,” 2024 IEEE International Conference on Machine Learning for Communication and Networking (ICMLCN), Stockholm, Sweden, 2024, pp. 183-188. [PDF](https://ieeexplore.ieee.org/document/10624801)
